...
<script>
  ...
  var testType = function(ds, t, elen) {
    ...
    assertEqual(ds.buffer.byteLength , ds.byteLength+boff);
    ds.seek(0);
    for (i=0; i<Math.floor(ds.byteLength/elen); i++) {
  ...
  var testSubArray = function (typedArrayConstructor, t, arr) {
      ...
      assertEqualArray(typedArr.subarray(1), outSubArray);
  }
  ...
  var testStruct = function() {
    ...
    assertEqual(JSON.stringify(o6), JSON.stringify(o6b));
    assertEqual(JSON.stringify(o6), JSON.stringify(o6c));
    assertEqualArray(u6, new Uint8Array(ds6.buffer));
    assertEqualArray(u6, new Uint8Array(ds6b.buffer));
    assertEqualArray(u6, new Uint8Array(ds6c.buffer));
  };
  ...
  assertEqual(ds.byteLength+64, buf.byteLength);
  ds.endianness = DataStream.LITTLE_ENDIAN;
  ds.writeUint16(1);
  ds.seek(0);
  ...
  assertEqual(ds.position+64 , buf.byteLength);
  assertEqual(ds.byteLength+64 , buf.byteLength);
  ...
  assertEqual(ds.buffer.byteLength , 3996+64);
  ds.position = 3996;
  ...
  assertEqual(ds.position+64 , ds.buffer.byteLength);
  ...
  assertEqual(ds.buffer.byteLength , ds.position+64);
